...
rm /var/www/merlin/tmp/bundle/programs/server/node_modules/.bin/has-ansi
rm /var/www/merlin/tmp/bundle/programs/server/node_modules/.bin/strip-ansi
rm /var/www/merlin/tmp/bundle/programs/server/node_modules/.bin/supports-color
